/************************************************************************/
/*                                                                      */
/* Make Ansi to Unicode Charmap 1.0 (Latin front-end) for next-c4 lib.  */
/*                                                                      */
/* Version: 1.0                                                         */
...
int _tmain(int argc, _TCHAR* argv[])
{
    ...
    ofstream outfile_littleendian("../maps/dest/front-latin2u-little-endian.map",ios::binary);
    if (!outfile_littleendian)
    {
        cerr<<"Can not open ../maps/dest/front-latin2u-little-endian.map!\n";
        return -1;
    }
