/************************************************************************/
/*                                                                      */
/* Make Ansi to Unicode Charmap 1.0 (Big5 front-end) for next-c4 lib.   */
/*                                                                      */
/* Version: 1.0                                                         */
...
int _tmain(int argc, _TCHAR* argv[])
{
    ...
    ofstream outfile_littleendian("../maps/dest/front-b2u-little-endian.map",ios::binary);
    if (!outfile_littleendian)
    {
        cerr<<"Can not open ../maps/dest/front-b2u-little-endian.map!\n";
        return -1;
    }
